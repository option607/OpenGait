...
# # **************** For Gait3D ****************
CUDA_VISIBLE_DEVICES=0,1,2,3 python -m torch.distributed.launch --nproc_per_node=4 opengait/main.py --cfgs /media/data/qinxiaohuan/OpenGait/configs/skeletongait/skeletongait_Gait3D.yaml --phase train